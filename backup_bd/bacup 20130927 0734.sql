...
INSERT INTO `cadastro` (`id`,`nome`,`quandequest`) VALUES 
 (1,';jairo chaves',3);
...
INSERT INTO `certificado` (`id`,`marcada`) VALUES 
 (1,0);
/*!40000 ALTER TABLE `certificado` ENABLE KEYS */;


--
-- Definition of table `certificadoerrados`
--

DROP TABLE IF EXISTS `certificadoerrados`;
CREATE TABLE `certificadoerrados` (
  `id` bigint(255) unsigned NOT NULL AUTO_INCREMENT,
  `errado` int(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `certificadoerrados`
--

/*!40000 ALTER TABLE `certificadoerrados` DISABLE KEYS */;
INSERT INTO `certificadoerrados` (`id`,`errado`) VALUES 
 (1,0),
 (2,0),
 (3,0);
/*!40000 ALTER TABLE `certificadoerrados` ENABLE KEYS */;
...
INSERT INTO `contador` (`id`,`ch`,`cn`,`lc`,`mt`) VALUES 
 (1,0,0,0,0);
...
CREATE TABLE `questoes` (
  ...
  `qii` varchar(255) NOT NULL,
  `certo` varchar(255) NOT NULL,
  `aenem` varchar(255) NOT NULL,
  `c_o_e` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `questoes` (`id`,`enunciado`,`pi`,`si`,`ti`,`qi`,`qii`,`certo`,`aenem`,`c_o_e`) VALUES 
 (1,0x6A6169726F,'a','a','a','a','a','Primeiro item','CIENCIAS HUMANAS','nao visto'),
 (2,0x6A6169726F,'a','a','a','a','a','Segundo item','CIENCIAS DA NATUREZA','nao visto'),
 (3,0x6A6169726F,'a','a','a','a','a','Segundo item','LINGUAGENS E CÓDIGOS','nao visto'),
 (4,0x6A6169726F,'a','a','a','a','a','Segundo item','MATEMÁTICA','nao visto');
